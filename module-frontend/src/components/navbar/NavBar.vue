        ...
        <v-navigation-drawer v-model="drawer" app clipped left hide-overlay>
          <v-list>
            ...
            <v-list-item>
              ...
              <v-list-item-content>
                <v-list-item-title
                  ><router-link to="/home">{{ $t("home") }}</router-link></v-list-item-title
                >
              </v-list-item-content>
            </v-list-item>
            ...
            <v-list-item>
              ...
              <v-list-item-content>
                <v-list-item-title
                  ><router-link to="/about">{{ $t("about") }}</router-link></v-list-item-title
                >
              </v-list-item-content>
            </v-list-item>
            ...
            <v-list-item>
              ...
              <v-list-item-content>
                <v-list-item-title
                  @click="logout()"><a color="primary" class="underline">{{ $t("logout") }}</a></v-list-item-title
                >
              </v-list-item-content>
            </v-list-item>
          </v-list>
