...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
    	http
    		.authorizeRequests()
    			...
    			.antMatchers("/module/actuator/**").permitAll()
    			...
    			.antMatchers("/module/auth/*").permitAll();
    }
    ...
    public void configure(WebSecurity web) throws Exception {
        web
	    	.ignoring()
	    		.antMatchers("/module")
	    		.antMatchers("/module/actuator/**")
	    		.antMatchers("/module/init")
	    		.antMatchers("/module/static/js/*")
	    		.antMatchers("/module/static/css/*")
	    		.antMatchers("/module/static/img/*")
	    		.antMatchers("/module/favicon.ico")
	    		.antMatchers("/foo/*")
